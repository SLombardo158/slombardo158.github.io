...
export const projects: Project[] = [
    ...
    { id: 3, title: "FCLWebVis - Data Visualization Framework", blurb: "Met one-on-one with leading Professor about vector manipulation and code base", stack: ["React", "Vector Math"], href: "https://www2.cs.uh.edu/~chengu/Publications/3DFlowVis/FCLWebVis_VDA23.pdf" }
];